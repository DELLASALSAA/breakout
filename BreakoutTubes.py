...
MERAH = (255, 0, 0)  # WARNA MERAH
BIRU = (0, 0, 255)  #WARNA BIRU
NETRAL = (100, 100, 100)  # WARNA ABU" ATAU NETRAL
KUNING = (255, 255, 0)  # WARNA KUNING
OREN = (255, 165, 0)  # WARNA OREAN
PINK = (252, 100, 203)  # WARNA PINK

######################## ASET ###################################
# MENAMPIKAN JUDUL PADA GAME
MUKA_KELOMPOK = pygame.image.load(r'Foto_tubes.png')
...
huruf = pygame.font.SysFont('Ubuntu', 30)
...
class Tombol:
    def __init__(self, x, y, tulisan, warna):
        ...
        self.warna_hover = (75, 225, 255)
        self.warna_klik = (50, 150, 255)
        self.warna_tulisan = HITAM
        self.lebar = 180
        self.tinggi = 70
...
class Tembok():
    def __init__(self):
        ...
        self.baris_inti = 6
        self.kolom_inti = 6  
        # MEMBUAT DEKLARASI PANJANG DAN LEBAR TEMBOK
...
class Bola:
    ...
    def gerak(self):
        ...
        for baris in tembok.kotak:
            ...
            for benda in baris:
                ...
                if self.rect.colliderect(benda[0]):
                    ...
                    # MENEGCEK AKAKAH TEMBOK ABU ABU HANCUR
                    ...
                    #MENGECEK SAAT BETON OREN HANCUR
                        ...
                        SUARA_KENA_TEMBOK.play()
                        # SAAT BETON ANCUR 12X MAKA BETON AKAN KEMBALI SEMULA DENGAN WARNA ABU-ABU DAN JUGA KECEPATAN BOLA BERTAMBAH
                        if self.hitung % 12 == 0 :
        ...
        if self.rect.colliderect(pemain):
            ...
            #SAAT BETON ANCUR 12X MAKA BOLA DI CEK NYENTUK GAYUNG ATAU TIDAK
...
warna_bola = Tombol(75, 350, 'BOLA', NETRAL)
warna_tangan = Tombol(325, 350, 'TANGAN', NETRAL)

################### OBJEK MENU UNTUK MEMILIH WARNA #############
merah = Tombol(75, 200, 'MERAH', MERAH)
kuning = Tombol(325, 200, 'KUNING', KUNING)
hijau = Tombol(75, 350, 'HIJAU', HIJAU)
